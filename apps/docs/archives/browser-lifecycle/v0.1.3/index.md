...
> [!NOTE]
> **Archived documentation (v0.1.3)** — You are viewing a frozen snapshot for `@jayoncode/browser-lifecycle@0.1.3`. See the [latest docs](/packages/browser-lifecycle/) for the current release.
