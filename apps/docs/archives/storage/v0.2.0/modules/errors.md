---
title: Errors
description: Storage documentation for Errors.
---
...
| `QuotaExceededError` | `quota_exceeded`      | Browser (or Lab) quota on write                           |
...
::: info Playground
Enable **Simulate quota on set** in the [Lab](/playground/storage/) to exercise `QuotaExceededError`.
:::
