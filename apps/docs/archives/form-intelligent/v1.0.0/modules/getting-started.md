...
The steps below follow the **headless** path, then show the matching **HTML / JSX structure** so you can see how elements map to the API. For more adapter variants, see [Adapters](/packages/form-intelligent/modules/adapters).
...
For `pnpm` / `yarn` and the React adapter, see [Overview → Install](/packages/form-intelligent/#install).
...
| ------------------------------ | --------------------------------------------------------------- | --------------------------------------------------------- |
| Terminology and architecture   | [Core concepts](/packages/form-intelligent/modules/concepts)    | [State](/playground/form-intelligent/state)               |
...
| Submit, cancel, offline queue  | [Submission](/packages/form-intelligent/modules/submission)     | [Submission](/playground/form-intelligent/submission)     |
| Autosave, drafts, wizard       | [Workflow](/packages/form-intelligent/modules/workflow)         | [Workflow](/playground/form-intelligent/workflow)         |
| Conditional `when()` rules     | [Rules](/packages/form-intelligent/modules/rules)               | [Rules](/playground/form-intelligent/rules)               |
| Derived fields                 | [Calculations](/packages/form-intelligent/modules/calculations) | [Calculations](/playground/form-intelligent/calculations) |
| Snapshots, undo/redo           | [State](/packages/form-intelligent/modules/state)               | [State](/playground/form-intelligent/state)               |

Additional snippets: [Examples](/playground/form-intelligent/examples) · Integrations: [Integrations](/packages/form-intelligent/modules/integrations)
