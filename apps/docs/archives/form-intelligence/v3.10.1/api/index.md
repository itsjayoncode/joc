...
| Property                       | Modifier   | Type      |
| ------------------------------ | ---------- | --------- |
| <a id="kind"></a> `kind`       | `readonly` | `"json"`  |
| <a id="values-3"></a> `values` | `readonly` | `TValues` |
...
| Property                         | Modifier   | Type          |
| -------------------------------- | ---------- | ------------- |
| <a id="kind-1"></a> `kind`       | `readonly` | `"multipart"` |
| <a id="formdata"></a> `formData` | `readonly` | `FormData`    |
...
| Property                            | Modifier   | Type      | Description                                                               |
| ----------------------------------- | ---------- | --------- | ------------------------------------------------------------------------- |
| <a id="omitempty"></a> `omitEmpty?` | `readonly` | `boolean` | Skip empty strings, empty file arrays, null, and undefined. Default true. |
...
| Property                        | Modifier   | Type                                                             | Description                                                           |
| ------------------------------- | ---------- | ---------------------------------------------------------------- | --------------------------------------------------------------------- |
| <a id="values-5"></a> `values`  | `readonly` | `TValues`                                                        | -                                                                     |
...
| Property                         | Modifier   | Type                           |
| -------------------------------- | ---------- | ------------------------------ |
| <a id="kind-2"></a> `kind?`      | `readonly` | `"value"`                      |
...
| Property                           | Modifier   | Type                                                                 | Description                          |
| ---------------------------------- | ---------- | -------------------------------------------------------------------- | ------------------------------------ |
| <a id="kind-3"></a> `kind`         | `readonly` | `"file"`                                                             | -                                    |
| <a id="name-7"></a> `name`         | `readonly` | `string`                                                             | -                                    |
| <a id="files"></a> `files`         | `readonly` | `File`[]                                                             | Canonical file selection (`File[]`). |
| <a id="onchange-1"></a> `onChange` | `readonly` | (`files`: `File`[] \| `FileList` \| `null` \| `undefined`) => `void` | -                                    |
| <a id="onblur-2"></a> `onBlur`     | `readonly` | () => `void`                                                         | -                                    |
| <a id="onfocus-2"></a> `onFocus`   | `readonly` | () => `void`                                                         | -                                    |
...
| <a id="upload"></a> `upload?`               | `readonly` | `SubmitUploadMeta`                          | Populated after a successful upload-transport submit.  |
...
| Property                            | Modifier   | Type                   |
| ----------------------------------- | ---------- | ---------------------- |
| <a id="values-6"></a> `values?`     | `readonly` | `Partial`\<`TValues`\> |
...
| <a id="kind-4"></a> `kind`           | `readonly` | `"checkpoint"`                                                      |
| <a id="capturedat"></a> `capturedAt` | `readonly` | `number`                                                            |
| <a id="values-8"></a> `values`       | `readonly` | `TValues`                                                           |
...
| Parameter  | Type                                      |
| ---------- | ----------------------------------------- |
| `options?` | [`ToFormDataOptions`](#toformdataoptions) |
...
[`FormPayload`](#formpayload)\<`TValues`\>
...
```ts
type FormPayload<TValues> = JsonFormPayload<TValues> | MultipartFormPayload;
```
...
```ts
type FieldBinding = ValueFieldBinding | FileFieldBinding;
```
...
| Parameter | Type                              |
| --------- | --------------------------------- |
| `limit`   | [`FileSizeInput`](#filesizeinput) |
