...
Canonical packages are **`@jayoncode/form-intelligence*`**. The old `@jayoncode/form-intelligence*` compatibility packages are **EOL** — removed from this monorepo and no longer published. Last published versions on npm stay installable but will not receive updates; migrate ASAP.

| Before (EOL)                          | After                                  |
| ------------------------------------- | -------------------------------------- |
| `@jayoncode/form-intelligence`        | `@jayoncode/form-intelligence`         |
...
```bash
npm uninstall @jayoncode/form-intelligence @jayoncode/form-intelligent-react
