...
Pin `@jayoncode/browser-lifecycle` to a specific version in production. Review [Migration](/migration/) before upgrading across minor versions once the package is published.
