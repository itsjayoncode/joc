...
- [`mergeBrowserLifecycleConfig`](/api/browser-lifecycle/)
- [`validateBrowserLifecycleConfig`](/api/browser-lifecycle/)
- [`getDefaultBrowserLifecycleConfig`](/api/browser-lifecycle/)
