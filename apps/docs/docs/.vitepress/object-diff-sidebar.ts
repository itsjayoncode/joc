  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "7. Statistics", link: `${base}/modules/stats` },
        { text: "8. Plugins", link: `${base}/modules/plugins` },
        { text: "9. Integrations", link: `${base}/modules/integrations` },
        { text: "10. Performance", link: `${base}/modules/performance` },
        { text: "11. DX", link: `${base}/modules/dx` },
      ],
    },
    {
      text: "Support",
