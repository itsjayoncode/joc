  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "4. DX / DiffView", link: `${base}/modules/dx` },
        { text: "5. Engines", link: `${base}/modules/engines` },
        { text: "6. Merge", link: `${base}/modules/merge` },
        { text: "7. Query", link: `${base}/modules/query` },
        { text: "8. Statistics", link: `${base}/modules/stats` },
        { text: "9. Plugins", link: `${base}/modules/plugins` },
        { text: "10. Integrations", link: `${base}/modules/integrations` },
        { text: "11. Performance", link: `${base}/modules/performance` },
      ],
    },
    {
      text: "Support",
