  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "10. Quota", link: `${base}/modules/quota` },
        { text: "11. Transforms", link: `${base}/modules/transforms` },
        { text: "12. Composition", link: `${base}/modules/composition` },
        { text: "13. Recipes", link: `${base}/modules/recipes` },
        { text: "14. Best practices", link: `${base}/modules/best-practices` },
      ],
    },
    {
      text: "Support",
