...
| ------ | ------ |
| `TType` *extends* [`BrowserLifecycleEventName`](#browserlifecycleeventname) | - |
| `TCurrent` | - |
| `TPrevious` | - |
...
| Type Parameter |
| ------ |
| `TEventName` *extends* [`BrowserLifecycleEventName`](#browserlifecycleeventname) |
...
| ------ |
| `TEventMap` *extends* [`EventMap`](#eventmap) |
| `TEventName` *extends* [`EventName`](#eventname)\<`TEventMap`\> |
