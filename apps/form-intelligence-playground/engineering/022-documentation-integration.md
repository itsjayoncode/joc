...
Phase 3.17 introduces the Form Intelligence documentation platform inside the existing VitePress site.
...
- Cross-link documentation with the Form Intelligence Playground and framework examples

## Architecture

```text
packages/form-intelligence/src
  -> TypeDoc -> apps/docs/docs/api/form-intelligence

packages/form-intelligence/docs
  -> sync script -> apps/docs/docs/packages/form-intelligence/modules
...
Construction docs refer to **Form Intelligence** and `createBrowserSession()`. The canonical implementation is `@jayoncode/form-intelligence` and `createBrowserLifecycle()`.
