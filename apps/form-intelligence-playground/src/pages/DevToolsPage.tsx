...
const DEVTOOLS_DRAFT_KEY = "joc.form-intelligence-playground.devtools-workflow";
      ...
      <div className={styles.explorerLayout}>
        <div className={styles.stack}>
              ...
              <li>
                <label className={styles.checkboxRow}>
                  ...
                  <span>
                    ...
                    <br />
                    <span className={styles.muted}>Uses the [form-intelligence] prefix</span>
                  </span>
                </label>
              </li>
            </ul>
          ...
          <Card description="Console access for local debugging." title="Global hook">
            <CodeBlock
              code={`import { connectFormDevToolsToGlobal, getFormDevTools } from "@jayoncode/form-intelligence/devtools";\n\nconnectFormDevToolsToGlobal();\n// window.__FORM_INTELLIGENT_DEVTOOLS__.getActiveForms()`}
              language="typescript"
            />
          </Card>
        </div>
