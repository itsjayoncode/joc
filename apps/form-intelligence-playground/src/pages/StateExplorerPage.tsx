...
export function StateExplorerPage() {
  ...
  return (
    ...
    >
      <ExplainPanel
        body="Form Intelligence exposes the full form OS state: values, errors, fieldUi, formUi.submitDisabled, fieldMeta.isValidating, fieldOptions, and submissionQueue."
