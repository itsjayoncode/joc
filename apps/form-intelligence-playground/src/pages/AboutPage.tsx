...
const folderResponsibilities = [
  ...
  ["lib", "Package integration boundary — import @jayoncode/form-intelligence here only."],
...
export function AboutPage() {
  return (
    <PageContainer
      description="Form Intelligence is a headless form workflow engine. This playground exists to teach the API interactively before you install the package."
      eyebrow="About"
      title="Product positioning"
    >
      <ExplainPanel title="What Form Intelligence is (and is not)">
