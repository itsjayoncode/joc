# QA Checklist — Form Intelligence Playground v1.0.0
...
- [x] `pnpm form-intelligence-playground:build` succeeds
- [x] `pnpm form-intelligence-playground:preview` serves production bundle
