...
const playgroundVersion = readPackageVersion("apps/form-intelligence-playground");
const formIntelligentVersion = readPackageVersion("packages/form-intelligence");
const formIntelligentReactVersion = readPackageVersion("packages/form-intelligence-react");
