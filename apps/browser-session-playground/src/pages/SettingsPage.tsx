...
export function SettingsPage() {
  ...
  return (
    <PageContainer
      description="Application-level preferences live here so future module pages can stay focused on Browser Lifecycle behavior instead of shell configuration."
      eyebrow="Settings"
