...
const routeObjects: RouteObject[] = [
  {
    ...
    children: [
      ...
      { element: <VisibilityPage />, path: "visibility" },
      { element: <FocusPage />, path: "focus" },
      { element: <ConnectivityPage />, path: "connectivity" },
      { element: <IdlePage />, path: "idle" },
      { element: <LifecyclePage />, path: "lifecycle" },
      { element: <CrossTabPage />, path: "cross-tab" },
      { element: <PluginsPage />, path: "plugins" },
      { element: <EventsPage />, path: "events" },
      { element: <StatePage />, path: "state" },
      { element: <ConfigurationPage />, path: "configuration" },
      { element: <PerformancePage />, path: "performance" },
      { element: <DeveloperToolsPage />, path: "developer-tools" },
