...
The Browser Session Playground is the official Browser Lifecycle engineering shell inside the JOC monorepo.
...
- live Browser Lifecycle session wiring through `src/lib/browser-lifecycle.ts`
...
- real plugin runtime through `@jayoncode/browser-lifecycle`
...
npx pnpm@10.13.1 --filter @jayoncode/browser-session-playground preview
