...
UI components never access `document` APIs directly. All Browser Lifecycle access stays behind `src/lib/browser-lifecycle.ts`.
...
- `src/lib/browser-lifecycle.test.ts` covers integration helpers and event-log formatting
