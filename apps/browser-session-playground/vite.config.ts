...
const playgroundVersion = readPackageVersion("apps/browser-session-playground");
const browserLifecycleVersion = readPackageVersion("packages/browser-lifecycle");
...
export default defineConfig({
  ...
  define: {
    __BROWSER_LIFECYCLE_VERSION__: JSON.stringify(browserLifecycleVersion),
