# Known Issues — Form Intelligent Playground v1.0.0
...
File new issues at https://github.com/itsjayoncode/joc/issues with the `form-intelligent-playground` label.
