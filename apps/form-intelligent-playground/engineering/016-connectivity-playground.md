...
ConnectivityPage
  -> useConnectivityPlayground()
    -> createConnectivityPlaygroundSession() in lib/form-intelligent.ts
...
Phase `3.6` required the Connectivity module in `@jayoncode/form-intelligent`:

- `packages/form-intelligent/src/modules/connectivity/`
- public events: `connection:online`, `connection:offline`, `connection:reconnect`
- snapshot field: `connectivity`

## Tests

- `src/lib/form-intelligent.test.ts` covers connectivity integration helpers and event-log formatting
