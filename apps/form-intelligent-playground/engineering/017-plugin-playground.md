...
Phase 3.10 adds `/plugins` to the Form Intelligent Playground and implements a real plugin runtime in `@jayoncode/form-intelligent`.

## Package changes

- Extended `BrowserLifecyclePlugin` with lifecycle hooks and metadata
- Added `PluginRuntime` under `packages/form-intelligent/src/plugins/`
