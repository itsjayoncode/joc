...
This document records the implementation shape of the Form Intelligent Playground foundation.
...
4. Form Intelligent integration
...
- `src/lib`: **Form Intelligent integration boundary** (see below)
...
All runtime imports from `@jayoncode/form-intelligent` and `@jayoncode/form-intelligent-react` flow through `src/lib/form-intelligent.ts`.
