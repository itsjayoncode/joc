...
export function DashboardPage() {
  ...
  return (
    ...
    >
      <ExplainPanel
        body="@jayoncode/form-intelligent manages everything that happens before, during, and after form submission — not just validation. Keep your HTML. Make your forms smarter."
