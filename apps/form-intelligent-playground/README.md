...
The Form Intelligent Playground is the official Form Intelligent engineering shell inside the JOC monorepo.
...
- live Form Intelligent session wiring through `src/lib/form-intelligent.ts`
...
- real plugin runtime through `@jayoncode/form-intelligent`
...
```bash
npx pnpm@10.13.1 --filter @jayoncode/form-intelligent-playground dev
npx pnpm@10.13.1 --filter @jayoncode/form-intelligent-playground build
npx pnpm@10.13.1 --filter @jayoncode/form-intelligent-playground preview
npx pnpm@10.13.1 --filter @jayoncode/form-intelligent-playground test
```
