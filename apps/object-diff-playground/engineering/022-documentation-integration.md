...
Phase 3.17 introduces the Object Diff documentation platform inside the existing VitePress site.
...
- Cross-link documentation with the Object Diff Playground and framework examples

## Architecture

```text
packages/object-diff/src
  -> TypeDoc -> apps/docs/docs/api/object-diff

packages/object-diff/docs
  -> sync script -> apps/docs/docs/packages/object-diff/modules

apps/object-diff-playground/docs
...
Construction docs refer to **Object Diff** and `createBrowserSession()`. The canonical implementation is `@jayoncode/object-diff` and `createBrowserLifecycle()`.

## Playground URL

Local playground: `http://127.0.0.1:4275`
