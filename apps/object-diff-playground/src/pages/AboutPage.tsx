...
const folderResponsibilities = [
  ...
  ["lib", "Object Diff package integration boundary."],
  ...
  return (
    ...
    >
      <div className={styles.cardGrid}>
        ...
        />
        <Card
          description="The shell owns theme, navigation, and recent route state. Object Diff runtime state remains behind a dedicated integration layer."
