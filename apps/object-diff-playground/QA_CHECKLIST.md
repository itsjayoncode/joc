# QA Checklist — Object Diff Playground v1.0.0
...
- [x] `pnpm object-diff-playground:build` succeeds
- [x] `pnpm object-diff-playground:preview` serves production bundle

## Application startup

- [x] Dev server starts on port 4275
