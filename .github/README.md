...
| **Storage**           | [`@jayoncode/storage`](https://www.npmjs.com/package/@jayoncode/storage)                     | —                                            | [Docs](https://itsjayoncode.github.io/joc/packages/storage/)           | [Playground](https://itsjayoncode.github.io/joc/playground/storage/)           |
...
- **Storage** — policy-driven client persistence: envelopes, TTL, migrations, adapters, soft quota, transforms
...
| Storage           | https://itsjayoncode.github.io/joc/packages/storage/           |
...
Only **public**, non-ignored packages are eligible for npm publication. That includes the Browser Lifecycle, Form Intelligence (and adapters / compatibility shims), Object Diff, and Storage families above.
