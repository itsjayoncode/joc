...
- Publishable packages today: `@jayoncode/browser-lifecycle`, `@jayoncode/form-intelligence`, `@jayoncode/object-diff`, plus their framework/schema adapters under `packages/`
