...
How-to, import choices, and DOM wrappers: [Rules guide](/packages/form-intelligent/modules/rules). Capability map: [Capabilities](/packages/form-intelligent/modules/capabilities).
...
| Goal                  | Guide                                                           |
| --------------------- | --------------------------------------------------------------- |
| Feature map / roadmap | [Capabilities](/packages/form-intelligent/modules/capabilities) |
...
| Conditional logic     | [Rules](/packages/form-intelligent/modules/rules)               |
