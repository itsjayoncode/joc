...
Canonical information architecture for user-facing docs across JOC packages (`@jayoncode/form-intelligent`, `@jayoncode/object-diff`, `@jayoncode/browser-lifecycle`, and future libraries).
...
## Form Intelligent mapping (first package)
