...
if (!existsSync(join(distRoot, "index.js"))) {
  console.error("Missing dist/ — run: pnpm exec tsc -b packages/form-intelligence");
  process.exit(1);
}
...
const alias = {
  "@jayoncode/form-intelligence": join(distRoot, "index.js"),
  "@jayoncode/form-intelligence/validation": join(distRoot, "validation/index.js"),
  "@jayoncode/form-intelligence/format": join(distRoot, "format/index.js"),
  "@jayoncode/form-intelligence/rules": join(distRoot, "rules/index.js"),
  "@jayoncode/form-intelligence/workflow": join(distRoot, "workflow/index.js"),
  "@jayoncode/form-intelligence/draft": join(distRoot, "draft/index.js"),
  "@jayoncode/form-intelligence/wizard": join(distRoot, "wizard/index.js"),
  "@jayoncode/form-intelligence/submission": join(distRoot, "submission/index.js"),
  "@jayoncode/form-intelligence/plugins": join(distRoot, "plugins/index.js"),
  "@jayoncode/form-intelligence/analytics": join(distRoot, "analytics/index.js"),
  "@jayoncode/form-intelligence/offline": join(distRoot, "offline/index.js"),
  "@jayoncode/form-intelligence/history": join(distRoot, "history/index.js"),
  "@jayoncode/form-intelligence/devtools": join(distRoot, "devtools/index.js"),
};
...
console.log("@jayoncode/form-intelligence bundle budgets (entry chunk, minified + gzip):\n");
