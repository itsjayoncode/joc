...
`@jayoncode/form-intelligence` is a **native form intelligence engine** for the JOC ecosystem.
...
| Package                                | Purpose                               |
| -------------------------------------- | ------------------------------------- |
| `@jayoncode/form-intelligence`         | Framework-independent engine          |
| `@jayoncode/form-intelligence-react`   | React hooks and bindings (`useForm`)  |
| `@jayoncode/form-intelligence-vue`     | Vue composables (planned)             |
| `@jayoncode/form-intelligence-angular` | Angular services/directives (planned) |
...
| **Framework adapters** | `@jayoncode/form-intelligence-react` (`useForm`)                                                           | React adapter shipped  |
...
|              | React Hook Form                          | Form Intelligence                               |
| ------------ | ---------------------------------------- | ----------------------------------------------- |
...
Can be used **together**: RHF for field registration in React-heavy apps; Form Intelligence for workflow orchestration — or Form Intelligence alone when markup is plain HTML or `name` attributes suffice.

## Marketing line

**Keep your HTML. Make your forms smarter.**

**One sentence:** `@jayoncode/form-intelligence` is a headless form workflow engine that manages everything that happens before, during, and after form submission — validation is one feature; the real value is centralizing the entire lifecycle of complex forms while developers keep complete control over UI.
