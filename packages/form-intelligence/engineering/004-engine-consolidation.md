...
Fold the four Phase B satellite packages back into `@jayoncode/form-intelligence` as domain engines. After this, consumers install **one package** and import optional engines via subpaths.
...
| `npm install @jayoncode/form-intelligence` pulls all satellites | Optional code only loads when subpath imported |
...
```bash
mkdir -p packages/form-intelligence/src/engines/{formatter,offline,analytics,workflow,draft,wizard}
```
...
```bash
git mv packages/form-intelligent-formatter/src packages/form-intelligence/src/engines/formatter
git mv packages/form-intelligent-offline/src packages/form-intelligence/src/engines/offline
git mv packages/form-intelligent-analytics/src packages/form-intelligence/src/engines/analytics
...
Replace across `packages/form-intelligence/`:
...
In `packages/form-intelligence/package.json`, delete:
...
**`packages/form-intelligence/tsconfig.json`** — remove satellite project references.
...
```bash
pnpm exec vitest run packages/form-intelligence/tests packages/form-intelligence-react/tests
```

### 8. Update playground and docs

- `apps/form-intelligence-playground` — no import changes if using `@jayoncode/form-intelligence` barrel
...
| ---------------------------------------------------------------------- | ------------------------------------------------------------ |
| `import { createForm, when } from "@jayoncode/form-intelligence"`      | ✅ unchanged                                                 |
| `import { when } from "@jayoncode/form-intelligence/workflow"`         | ✅ unchanged                                                 |
| `import { applyFormatter } from "@jayoncode/form-intelligence/format"` | ✅ unchanged                                                 |
...
- [x] `packages/form-intelligence/package.json` has no `@jayoncode/form-intelligent-*` dependencies
