...
| `…/validation`                 | Pipeline helpers (`runValidationPipeline`, `toNormalizedErrors`, …), `matchesField`, `requiredWhen`, re-exported validators — [Validation → pipeline helpers](/packages/form-intelligence/modules/validation#pipeline-helpers-validation) | Validators yes; helpers prefer this path                                                                                                                    |
