...
Wire a field, observe state, and submit in a few minutes. Progressive path: **Basic** (this page) → [Concepts](/packages/form-intelligence/modules/concepts) → feature guides → [Playground](/playground/form-intelligence/).
...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Basic        | This tutorial                                                                                                                       | [Validation](/playground/form-intelligence/validation)                                            |
| Intermediate | [Rules (`when()`)](/packages/form-intelligence/modules/rules) · [Workflow / autosave](/packages/form-intelligence/modules/workflow) | [Rules](/playground/form-intelligence/rules) · [Workflow](/playground/form-intelligence/workflow) |
| Advanced     | [Plugins](/packages/form-intelligence/modules/plugins) · [Performance](/packages/form-intelligence/modules/performance)             | [Sandbox](/playground/form-intelligence/)                                                         |
