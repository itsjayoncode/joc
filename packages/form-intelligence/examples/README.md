# Form Intelligence examples

Runnable demos for `@jayoncode/form-intelligence`. Interactive UI lives in
[`apps/form-intelligence-playground`](../../apps/form-intelligence-playground).
...
pnpm --filter @jayoncode/form-intelligence typecheck:examples

# Smoke-run them (vitest + jsdom)
pnpm -w exec vitest run packages/form-intelligence/tests/integration/examples-smoke.test.ts
```
...
| File                                     | Package                                |
| ---------------------------------------- | -------------------------------------- |
| [`react-basic.tsx`](./react-basic.tsx)   | `@jayoncode/form-intelligence-react`   |
| [`vue-basic.ts`](./vue-basic.ts)         | `@jayoncode/form-intelligence-vue`     |
| [`angular-basic.ts`](./angular-basic.ts) | `@jayoncode/form-intelligence-angular` |
